...
class anuncio
{
    ...
    public function traerUnAnuncio()
    {
        ...
        $sql = " SELECT  a.id_anuncio, u.id_usuario, a.id_categoria, a.titulo, a.descripcion,  a.precio, 
    ...
    public function salvar()
    {
        ...
        $sql = "INSERT INTO anuncio (id_usuario, id_categoria, titulo, descripcion, precio, ubicacion, gusto) VALUES (:id_usuario, :id_categoria, :titulo, :descripcion, :precio, :ubicacion, :gusto)";
        ...
        $stmt->bindParam(':gusto', $gusto, PDO::PARAM_INT);
